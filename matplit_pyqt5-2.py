...
class Mymetrics_plCanvas(FigureCanvas):
    ...
    def cnf_matrix_plotter(self,classes,df:pd.DataFrame, cmap=plt.cm.Blues):
        ...
        self.axes.set_title('混淆矩阵', fontsize=30)
        self.axes.set_xlabel('预测类别', fontsize=25, c='r')
        self.axes.set_ylabel('真实类别', fontsize=25, c='r')
        # plt.ylabel('真实类别', fontsize=25, c='r')
        # plt.tick_params(labelsize=16) # 设置类别文字大小
        self.axes.tick_params(labelsize=12) # 设置类别文字大小
